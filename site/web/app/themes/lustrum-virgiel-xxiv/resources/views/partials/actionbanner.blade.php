    ...
    <section class="section action-banner lazy" data-src="@asset('images/front-page/lustrum_pattern.svg')">
        <div class="wrap container">
            <div class="level has-text-centered">
                <h3 class="is-size-4 is-size-6-mobile has-text-white is-uppercase has-text-weight-bold level-left {!! App::pageSlug() !!}-background">{{ the_field('action_banner_text') }}</h3>
