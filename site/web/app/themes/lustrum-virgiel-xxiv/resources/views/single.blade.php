        ...
        <div class="card">
            <div class="card-content">
                <div class="content is-uppercase has-text-weight-bold">
                    <div class="fact title-has-icon"><span class="icon" style="background-image:url('@asset('images/news-entry/calendar.svg')')"></span> <p class="has-subtitle"><span class="is-size-7">Laatste update: </span><time datetime="{!! the_modified_date('c') !!}">{!! the_modified_date() !!}, {!! the_modified_date('G:i') !!} uur</time></p></div>
