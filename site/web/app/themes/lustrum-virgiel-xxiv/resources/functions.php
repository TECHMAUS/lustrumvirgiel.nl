...
if( function_exists('acf_add_local_field_group') ):
	...
	acf_add_local_field_group(array(
		...
		'fields' => array(
			...
			array(
				...
				'name' => 'event_category',
				'type' => 'taxonomy',
				'instructions' => 'Selecteer de nieuwscategorieën die gekoppeld zijn aan dit event, dit wordt gebruik bij het weergeven van gerelateerds nieuwsberichten.',
				'required' => 0,
				'conditional_logic' => 0,
				'wrapper' => array(
					'width' => '50',
			...
			array(
				'key' => 'field_5af0134fbb6dd',
				'label' => 'Kaartverkoop link',
				'name' => 'tickets_url',
				'type' => 'url',
				'instructions' => 'De URL waar tickets voor dit event gekocht kunnen worden. Deze URL wordt gebruikt op de homepage, en als link bij de \'tickets\' knoppen bij de activiteiten.',
				'required' => 0,
				'conditional_logic' => 0,
				'wrapper' => array(
					'width' => '',
	...
	acf_add_local_field_group(array(
		...
		'fields' => array(
			array(
				...
				'name' => 'event_subtitle',
				'type' => 'text',
				'instructions' => 'Ondertitel die wordt weergegeven bovenaan de pagina.',
				'required' => 0,
				'conditional_logic' => 0,
				'wrapper' => array(
					'width' => '',
			...
			array(
				...
				'name' => 'event_tag',
				'type' => 'taxonomy',
				'instructions' => 'Selecteer de nieuwstags die gekoppeld zijn aan dit event, dit wordt gebruik bij het weergeven van gerelateerds nieuwsberichten.',
				'required' => 0,
				'conditional_logic' => 0,
				'wrapper' => array(
					'width' => '30',
			...
			array(
				...
				'default_value' => '',
				'placeholder' => 'Kaartsoorten + prijs',
				'prepend' => '',
				'append' => '',
				'maxlength' => '',
			),
			array(
				'key' => 'field_5aec642a17c3b',
				'label' => 'Uitverkocht?',
				'name' => 'sold_out',
				'type' => 'true_false',
				'instructions' => '',
			...
			array(
				'key' => 'field_5af0134fb759ef',
				'label' => 'Facebook event',
				'name' => 'fb_event_url',
				'type' => 'url',
				'instructions' => 'Link naar het Facebook event.',
				'required' => 0,
				'conditional_logic' => 0,
				'wrapper' => array(
					'width' => '',
				...
				'default_value' => '',
				'placeholder' => 'https://www.facebook.com/events/1612004352180291/',
			),
		),
		'location' => array(
			array(
	...
	acf_add_local_field_group(array(
		'key' => 'group_5ad45ae62cb17',
		'title' => 'Programmaoverzicht',
		'fields' => array(
			array(
				'key' => 'field_5ad45aec8ca2c',
				'label' => 'Activiteiten',
				'name' => 'activiteiten',
				'type' => 'repeater',
				'instructions' => '',
				...
				'sub_fields' => array(
					array(
						'key' => 'field_5ad45b148ca2d',
						'label' => 'Gerelateerde pagina',
						'name' => 'related_activity_page',
						'type' => 'post_object',
						'instructions' => 'Dit is de losse activiteit pagina die gerelateerd is aan deze activiteit. Dit wordt gebruikt om de afbeelding op te halen voor de achtergrond, en de juiste link in te stellen.',
						'required' => 1,
						'conditional_logic' => 0,
						'wrapper' => array(
							'width' => '',
					...
					array(
						'key' => 'field_5ad45b6a8ca2e',
						'label' => 'Titel',
						'name' => 'activity_title',
						'type' => 'text',
						'instructions' => 'Dit is de titel die in de tegel wordt weergegeven. Voeg zelf een enters in door &lt;br&gt; te typen op de plekken waar een enter moet staan.',
						'required' => 1,
						'conditional_logic' => 0,
						'wrapper' => array(
							'width' => '',
					...
					array(
						'key' => 'field_5ad48eabc6f4a',
						'label' => 'Afbeelding',
						'name' => 'activity_image',
						'type' => 'image',
						'instructions' => 'De afbeelding die op de achtergrond van de tegel wordt weergegeven.',
						'required' => 0,
						'conditional_logic' => 0,
						'wrapper' => array(
							'width' => '',
	...
	acf_add_local_field_group(array(
		'key' => 'group_5ad4babd32006',
		'title' => 'Artiestenoverzicht',
		'fields' => array(
			array(
				'key' => 'field_5ad4bac26f8eb',
				'label' => 'Artiesten',
				'name' => 'artists',
				'type' => 'repeater',
				'instructions' => 'Dit zijn de artiesten die moeten worden weergegeven op de activiteitenpagina.',
				'required' => 0,
				'conditional_logic' => 0,
				'wrapper' => array(
					'width' => '',
				...
				'max' => 0,
				'layout' => 'table',
				'button_label' => 'Artiest toevoegen',
				'sub_fields' => array(
					array(
						'key' => 'field_5ad4bae46f8ec',
						'label' => 'Artiest Naam',
						'name' => 'artist_name',
						'type' => 'text',
						'instructions' => '',
					...
					array(
						'key' => 'field_5ad4bafc6f8ed',
						'label' => 'Artiest link',
						'name' => 'artist_link',
						'type' => 'url',
						'instructions' => 'Link waar een gebruiker heengeleid moet worden worden als hij/zij op de artiest klikken.',
						'required' => 0,
						'conditional_logic' => 0,
						'wrapper' => array(
							'width' => '',
					...
					array(
						'key' => 'field_5ad4bb366f8ee',
						'label' => 'Artiest afbeelding',
						'name' => 'artist_image',
						'type' => 'image',
						'instructions' => 'De afbeelding van de artiest die getoond wordt.',
						'required' => 0,
						'conditional_logic' => 0,
						'wrapper' => array(
							'width' => '',
	...
	acf_add_local_field_group(array(
		'key' => 'group_5aec5e5bde2fc',
		'title' => 'Subevenement informatie',
		'fields' => array(
			array(
				'key' => 'field_5aec5f662d232',
			...
			array(
				'key' => 'field_5af2bdf288367',
				'label' => 'Stages',
				'name' => 'stages',
				'type' => 'repeater',
				'instructions' => 'Voeg verschillende stages toe waarvoor timetables weergegeven moeten worden.',
				'required' => 0,
				'conditional_logic' => 0,
				'wrapper' => array(
					'width' => '',
				...
				'max' => 0,
				'layout' => 'block',
				'button_label' => 'Timetable toevoegen',
				'sub_fields' => array(
					array(
						'key' => 'field_5af2bebb8836b',
						'label' => 'Titel',
						'name' => 'titel',
						'type' => 'text',
						'instructions' => 'Titel die boven de timetable weergegeven moet worden',
						'required' => 1,
						'conditional_logic' => 0,
						'wrapper' => array(
							'width' => '',
						...
						'default_value' => '',
						'placeholder' => 'vb. Main Stage',
						'prepend' => '',
						'append' => '',
						'maxlength' => '',
					),
					array(
						'key' => 'field_5af2be2288368',
						'label' => 'Timetable',
						'name' => 'timetable',
						'type' => 'repeater',
						'instructions' => '',
						...
						'max' => 0,
						'layout' => 'table',
						'button_label' => 'Tijdsblok toevoegen',
						'sub_fields' => array(
							array(
								'key' => 'field_5af2be5188369',
								'label' => 'Tijd',
								'name' => 'time',
								'type' => 'text',
								'instructions' => '',
								...
								'default_value' => '',
								'placeholder' => 'vb. 12:00 - 13:00',
								'prepend' => '',
								'append' => '',
								'maxlength' => '',
							),
							array(
								'key' => 'field_5af2be858836a',
								'label' => 'Artiest',
								'name' => 'artist',
								'type' => 'text',
								'instructions' => '',
